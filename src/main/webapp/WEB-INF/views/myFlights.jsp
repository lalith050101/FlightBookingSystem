...
<html>
    ...
    <div class="header">
            ...
            <a class="headerlink" href="/userFlights">Passenger flights</a>
    	
    	</div>
    	
    	
        <div align="center" class="product-list">
           <h1 id="pdheading">FLIGHTS LIST</h1>
            <table id="products" >
                <tr >
                <th>No</th>
                <th>SOURCE</th>
                ...
                <c:forEach var="flightTicket" items="${flightsTickets}" varStatus="status">
                <tr>
                    <td>${status.index + 1}</td>
                    <td>${flightTicket.flight.source}</td>
                    <td>${flightTicket.flight.destination}</td>
                    <td>${flightTicket.seatNo}</td>
                    <td>${flightTicket.flight.price}</td>
                    <td>${flightTicket.firstName}</td>
                    <td>${flightTicket.lastName}</td>
                    <td>${flightTicket.age}</td>
                    <td>${flightTicket.gender}</td>
                    
                    
                    
                    <td>
                        <a class="actionlink" href="/editPassengerDetails?ticketId=${flightTicket.ticketId}">Edit</a>

                     </td>
                    <td>    
                        <a class="actionlink" href="/cancelFlightTicket?ticketId=${flightTicket.ticketId}">Cancel</a>
                    </td>
