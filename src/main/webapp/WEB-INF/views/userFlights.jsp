...
<html>
    ...
    <div class="header">
        ...
        <div align="center" class="product-list">
           ...
           <form:form action="searchFlights" method="post">
         <input type="text" name="source" maxlength="30" required="required" placeholder="Enter Source">
         <input type="text" name="destination" maxlength="30" required="required" placeholder="Enter Destination">
         ...
         <h2 >${msg}</h2>
            <table id="products" >
                ...
                <tr>
                    ...
                    <td>${flight.maxSeats - flight.filledSeats}</td>
                    <td>${flight.price}</td>
                    
                    
                    <td>
                        <a class="actionlink" href="/bookFlight?code=${flight.code}">Book</a>
